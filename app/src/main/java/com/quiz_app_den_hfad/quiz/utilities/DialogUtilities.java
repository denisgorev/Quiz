...
public class DialogUtilities extends DialogFragment {
    ...
    public static DialogUtilities newInstance(String dialogTitle, String dialogText, String yes, String no, String viewIdText) {
        ...
        args.putString(AppConstans.BUNDLE_KEY_TITLE, dialogTitle);
        args.putString(AppConstans.BUNDLE_KEY_MESSAGE, dialogText);
        args.putString(AppConstans.BUNDLE_KEY_YES, yes);
        args.putString(AppConstans.BUNDLE_KEY_NO, no);
        args.putString(AppConstans.BUNDLE_KEY_VIEW_ID, viewIdText);
    ...
    public void initVar() {
        ...
        if (bundle != null) {
            dialogTitle = getArguments().getString(AppConstans.BUNDLE_KEY_TITLE);
            dialogText = getArguments().getString(AppConstans.BUNDLE_KEY_MESSAGE);
            positiveText = getArguments().getString(AppConstans.BUNDLE_KEY_YES);
            negativeText = getArguments().getString(AppConstans.BUNDLE_KEY_NO);
            viewIdText = getArguments().getString(AppConstans.BUNDLE_KEY_VIEW_ID);
        }
    }
