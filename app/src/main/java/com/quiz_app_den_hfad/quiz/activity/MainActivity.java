...
public class MainActivity extends BaseActivity {
    ...
    private void loadJson() {
        ...
        try{
            br = new BufferedReader(new InputStreamReader(getAssets().open(AppConstans.CONTENT_FILE)));
            String temp;
    ...
    private void parseJson(String jsonData) {
        try {
            ...
            JSONArray jsonArray = jsonObject.getJSONArray(AppConstans.JSON_KEY_ITEMS);

            for (int i = 0; i < jsonArray.length(); i++) {
                JSONObject object = jsonArray.getJSONObject(i);

                String categoryId = object.getString(AppConstans.JSON_KEY_CATEGORY_ID);
                String categoryName = object.getString(AppConstans.JSON_KEY_CATEGORY_NAME);
