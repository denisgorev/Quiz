...
import com.quiz_app_den_hfad.quiz.utilities.ActivityUtilities;
    ...
    public class QuizPromptActivity extends BaseActivity {
        ...
        private void initVar() {
            ...
            if (intent != null) {
                categoryId = intent.getStringExtra(AppConstans.BUNDLE_KEY_INDEX);
                score = AppPreference.getInstance(mContext).getString(categoryId);
                questionsCount = AppPreference.getInstance(mContext).getString(categoryId + AppConstans.QUESTIONS_IN_TEST);
            }
        }
