package com.quiz_app_den_hfad.quiz.constans;
...
public class AppConstans {
    ...
    // category file
    public static final String CONTENT_FILE = "json/categories/quiz_categories.json";
    ...
    // question file
    public static final String QUESTION_FILE = "json/quiz/questions_set.json";
